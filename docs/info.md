...
Long-lived design and implementation notes live here. Keep these documents consistent with the authoritative state in `milestone/current.md` and the rules in `AGENTS.md`.
